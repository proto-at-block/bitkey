...
locals {
  ...
  customer_server_key_shares_table_name = coalesce(var.customer_server_key_shares_table_override, "${module.this.id_dot}.customer_server_key_shares")
}
...
module "customer_server_key_shares_table" {
  source = "git::https://github.com/terraform-aws-modules/terraform-aws-dynamodb-table//?ref=9b66b76b2d178ca42425378deac9d9ebf95bf14e" // Tag v3.2.0

  name     = local.customer_server_key_shares_table_name
  hash_key = "root_key_id"

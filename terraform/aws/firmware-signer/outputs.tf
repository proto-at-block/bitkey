output "api_gw_base_url" {
  ...
  value = var.is_localstack ? "http://localhost:4566/_aws/execute-api/${aws_api_gateway_rest_api.api_gw.id}/${aws_api_gateway_stage.api_gw_stage.stage_name}/" : aws_api_gateway_stage.api_gw_stage.invoke_url
}

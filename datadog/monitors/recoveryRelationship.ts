...
export class RecoveryRelationshipMonitors extends Construct {
  constructor(scope: Construct, environment: Environment) {
    ...
    new HttpStatusCompositeMonitor(this, "4xx_recovery_relationship_status", {
      ...
      environment,
      tags: [{tag: "service:fromagerie-api", rateInclusion: "both"}, {tag: "router_name:recovery_relationship", rateInclusion: "both"}, {tag: "app_id:world.bitkey.app", rateInclusion: "both"}],
      rateThreshold: "0.1",
      countThreshold: "5",
      recipients,
    });

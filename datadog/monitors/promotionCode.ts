...
export class PromotionCodeMonitors extends Construct {
  constructor(scope: Construct, environment: Environment) {
    ...
    new HttpStatusCompositeMonitor(this, "4xx_promotion_code_status", {
      ...
      environment,
      tags: [{tag: "service:fromagerie-api", rateInclusion: "both"}, {tag: "router_name:promotion_code", rateInclusion: "both"}, {tag: "!status_exact:404", rateInclusion: "numerator"}, {tag: "app_id:world.bitkey.app", rateInclusion: "both"}],
      rateThreshold: "0.5",
      countThreshold: "4",
    ...
    new HttpStatusCompositeMonitor(this, "5xx_promotion_code_status", {
      ...
      group: "Promotion Code",
      environment,
      tags: [{tag: "service:fromagerie-api", rateInclusion: "both"}, {tag: "router_name:promotion_code", rateInclusion: "both"}, {tag: "app_id:world.bitkey.app", rateInclusion: "both"}],
      rateThreshold: "0.05",
      countThreshold: "2",

 ...
 * @file
 *
 * @brief Configuration for the UC Device.
 *
 * @{
 */
 ...
 */
#define UC_CFG_RD_BUFFER_SIZE 704u
 ...
 * @note For backwards-compatibility, this value should not be changed.
 */
#define UC_CFG_WR_BUFFER_SIZE 888u

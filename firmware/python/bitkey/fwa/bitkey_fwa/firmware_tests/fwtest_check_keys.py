...
class KeyChecks(bitkey_fwa.TestCase):
    ...
    def fwtest_verify_app_slot(self):
        ...
        self.assertEqual(
            self.get_elf_section_size(signature),
            ECC_SIGNATURE_SIZE,
    ...
    def fwtest_verify_app_certificate(self):
        ...
        if not FirmwareUnderTest.signed:
            ...
            return
        # get the  app cert
        app_certificate = self.get_elf_symbol_data("app_certificate", ".rodata")
    ...
    def fwtest_verify_loader_slot(self):
        ...
        signature_data_copy = self.get_elf_section_data(codesigning_signature_section)
    ...
    def fwtest_verify_bl_certificate(self):
        ...
        # get the loader cert
        bl_certificate = self.get_elf_symbol_data("bl_certificate", ".rodata")

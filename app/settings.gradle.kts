...
module(":domain:device-wipe:fake")
module(":domain:device-wipe:impl")
module(":domain:device-wipe:public")
...
module(":libs:chaincode-delegation:fake")
module(":libs:chaincode-delegation:impl")
module(":libs:chaincode-delegation:public")

...
module(":domain:bitcoin:fake")
module(":domain:bitcoin:impl")
module(":domain:bitcoin:public")
module(":domain:bitcoin:testing")
...
module(":domain:emergency-access-kit:fake")
module(":domain:emergency-access-kit:impl")
module(":domain:emergency-access-kit:public")
...
module(":domain:firmware:fake")
module(":domain:firmware:impl")
module(":domain:firmware:public")
module(":domain:fwup:fake")
module(":domain:fwup:impl")
module(":domain:fwup:public")
...
module(":domain:keybox:fake")
module(":domain:keybox:impl")
module(":domain:keybox:public")
...
module(":domain:nfc:fake")
module(":domain:nfc:impl")
module(":domain:nfc:public")
...
module(":domain:security-recommendations:fake")
module(":domain:security-recommendations:impl")
module(":domain:security-recommendations:public")

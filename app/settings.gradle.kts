...
module(":shared:contact-method:fake")
module(":shared:contact-method:impl")
module(":shared:contact-method:public")
...
module(":shared:di-scopes:public")
...
module(":shared:secure-enclave:fake")
module(":shared:secure-enclave:impl")
module(":shared:secure-enclave:public")

...
class DependencyLockingDependencyConfigurationPlugin : Plugin<Project> {
  ...
  private fun Project.pinDependencies(dependencyLockingExtension: DependencyLockingExtension) {
    dependencyLockingExtension.commonDependencyLockingGroups.buildClasspath.pin(
      ...
      libs.android.lifecycle.service,
      libs.android.lifecycle.process,
      libs.android.lifecycle.viewmodel.asProvider(),
      libs.android.lifecycle.viewmodel.ktx,
      libs.android.lifecycle.viewmodel.savedstate,
      libs.android.lifecycle.livedata.asProvider(),
      libs.android.lifecycle.livedata.core.asProvider(),
      libs.android.lifecycle.livedata.core.ktx,
      libs.android.lifecycle.livedata.ktx,
      libs.android.lifecycle.runtime.android,
      libs.android.lifecycle.runtime.ktx.android,
      libs.android.activity.asProvider(),
      libs.android.appcompat.asProvider(),
      libs.android.appcompat.resources,
      ...
      libs.android.compose.runtime.asProvider(),
      libs.android.compose.runtime.saveable,

...
import build.wallet.bitkey.inheritance.BeneficiaryCompleteClaim
import build.wallet.bitkey.inheritance.InheritanceClaimId
import com.github.michaelbull.result.Ok
import com.github.michaelbull.result.Result

class CompleteInheritanceClaimF8eClientFake(
  var response: Result<BeneficiaryClaim.CompleteClaim, Throwable> = Ok(BeneficiaryCompleteClaim),

...
class RouterTests : FunSpec({
  ...
  val stagingRoute = "https://web-site.bitkeystaging.com/links/downloads/trusted-contact?code=1234"
  val prodRoute = "https://bitkey.world/links/downloads/trusted-contact?code=1234"

  test("http routes fail") {
    Route.fromUrl(
      "http://web-site.bitkeystaging.com/links/downloads/trusted-contact?code=1234"
    ).shouldBeNull()
  }

  test("incorrect host fails") {
    Route.fromUrl("http://google.com/links/downloads/trusted-contact?code=1234").shouldBeNull()
  }

  test("incorrect path fails") {
    Route.fromUrl("http://google.com/links/dowoads/trusted-contact?code=1234").shouldBeNull()
  }

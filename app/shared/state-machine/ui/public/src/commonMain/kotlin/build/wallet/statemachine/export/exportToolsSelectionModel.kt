...
fun exportToolsSelectionModel(
  onBack: () -> Unit,
  onExportTransactionHistoryClick: () -> Unit,
  onExportDescriptorClick: () -> Unit,
) = FormBodyModel(
  onBack = onBack,
  toolbar = ToolbarModel(
    leadingAccessory = CloseAccessory(onBack),
    middleAccessory = ToolbarMiddleAccessoryModel(title = "Documents")
  ),

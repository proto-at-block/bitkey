  ...
  val stateMachine =
    HomeUiStateMachineImpl(
      appFunctionalityStatusUiStateMachine =
        object : AppFunctionalityStatusUiStateMachine, ScreenStateMachineMock<AppFunctionalityStatusUiProps>(
          "app-status"
        ) {},
      ...
      updateProps(
        props.copy(
          currencyPreferenceData =
            props.currencyPreferenceData.copy(fiatCurrencyPreference = EUR)
        )
      )
      currencyChangeMobilePayBottomSheetUpdater.setOrClearHomeUiBottomSheetCalls.awaitItem()

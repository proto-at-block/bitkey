 ...
 */
data class SpendingWalletDescriptor(
  override val identifier: String,
  override val networkType: BitcoinNetworkType,
  override val receivingDescriptor: BitcoinDescriptor.Spending,
  override val changeDescriptor: BitcoinDescriptor.Spending,
) : WalletDescriptor

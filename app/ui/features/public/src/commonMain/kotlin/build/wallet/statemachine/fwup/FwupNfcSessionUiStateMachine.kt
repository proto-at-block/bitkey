 ...
 * @property onDone: Callback for exiting the NFC session after completion. The expected firmware version is passed
 * to allow verification that the update was successful.
...
data class FwupNfcSessionUiProps(
  ...
  val onBack: () -> Unit,
  val onDone: (expectedVersion: String) -> Unit,
  val onError: (
    error: NfcException,

...
data class BenefactorApprovedClaimWarningBodyModel(
  val onTransferFunds: () -> Unit,
  val onClose: () -> Unit,
) : FormBodyModel(
    id = InheritanceEventTrackerScreenId.BenefactorApprovedClaimWarning,
    ...
    header = FormHeaderModel(
      ...
      subline = "Funds must be transferred before the beneficiary can be removed."
    ),

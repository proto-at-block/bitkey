...
val lightStyleDictionaryColors =
  object : StyleDictionaryColors {
    ...
    override val bitkeyPrimary: Color = Color(0xff000000)
    ...
    override val positiveForeground: Color = Color(0xff1CB843)
    ...
    override val loadingBackground: Color = Color(0xffF0F0F0)
...
val darkStyleDictionaryColors =
  object : StyleDictionaryColors {
    ...
    override val bitkeyPrimary: Color = Color(0xffFFFFFF)
    override val primaryForeground: Color = Color(0xFFFFFFFF)

 ...
 * Each variant represents a specific privileged action.
 */
...
public expect fun `buildPayload`(`action`: Action, `value`: kotlin.String?, `bindings`: List<ContextBindingPair>): List<kotlin.UByte>

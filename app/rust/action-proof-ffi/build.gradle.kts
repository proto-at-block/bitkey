...
kotlin.targets.withType<KotlinNativeTarget>().configureEach {
  compilations.getByName("main") {
    cinterops.register("actionproof") {
      packageName("actionproof.cinterop")
      header(actionproofCinteropHeader)
      defFile(actionproofCinteropDefFile)

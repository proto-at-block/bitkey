...
public interface BumpFeeTxBuilderInterface {
   ...
   */
  public fun `drainTo`(`script`: Script): BumpFeeTxBuilder
...
public expect open class BumpFeeTxBuilder : Disposable, BumpFeeTxBuilderInterface {
   ...
   * to the specified script, enabling output shrinking.
   */
  public override fun `drainTo`(`script`: Script): BumpFeeTxBuilder
...
public interface CbfBuilderInterface {
   ...
   */
  public fun `configureTimeoutMillis`(
...
public expect open class CbfBuilder : Disposable, CbfBuilderInterface {
   ...
   * 2. Respond to a request
   */
  public override fun `configureTimeoutMillis`(
    `handshake`: kotlin.ULong,
    `response`: kotlin.ULong,
  ): CbfBuilder
...
public expect open class ChangeSet : Disposable, ChangeSetInterface {
  ...
  public companion object {
    ...
    public fun `fromDescriptorAndNetwork`(
      `descriptor`: Descriptor?,
      `changeDescriptor`: Descriptor?,
      `network`: Network?,
    ): ChangeSet
...
public interface FullScanRequestBuilderInterface {
  ...
  @Throws(RequestBuilderException::class)
  public fun `inspectSpksForAllKeychains`(
...
public expect open class FullScanRequestBuilder : Disposable, FullScanRequestBuilderInterface {
  ...
  @Throws(RequestBuilderException::class)
  public override fun `inspectSpksForAllKeychains`(
    `inspector`: FullScanScriptInspector,
  ): FullScanRequestBuilder
...
public expect open class TxBuilder : Disposable, TxBuilderInterface {
   ...
   * below `0xFFFFFFFE` (e.g., `0xFFFFFFFD`).
   */
  public override fun `addForeignUtxo`(
    `outpoint`: OutPoint,
    `txout`: TxOut,
    `prevTx`: Transaction,
    `satisfactionWeight`: kotlin.ULong,
   ...
   * Add a recipient to the internal list of recipients.
   */
  public override fun `addRecipient`(
    `script`: Script,
    `amount`: Amount,
  ): TxBuilder
   ...
   * The TxBuilder::policy_path is a complex API. See the Rust docs for complete       information: https://docs.rs/bdk_wallet/latest/bdk_wallet/struct.TxBuilder.html#method.policy_path
   */
  public override fun `policyPath`(
    `policyPath`: Map<kotlin.String, List<kotlin.ULong>>,
    `keychain`: KeychainKind,
  ): TxBuilder
...
public expect open class Wallet : Disposable, WalletInterface {
   ...
   */
  @Throws(SignerException::class)
  public override fun `finalizePsbt`(
    `psbt`: Psbt,
   ...
   * [`list_output`]: Self::list_output
   */
  public override fun `insertTxout`(
    `outpoint`: OutPoint,
    `txout`: TxOut,
  )
   ...
   * [BIP32](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) max index.
   */
  public override fun `peekAddress`(
    `keychain`: KeychainKind,
    `index`: kotlin.UInt,
  ): AddressInfo
   ...
   * calls to this method before closing the wallet. See [`Wallet::reveal_next_address`].
   */
  public override fun `revealAddressesTo`(
    `keychain`: KeychainKind,
    `index`: kotlin.UInt,
  ): List<AddressInfo>
   ...
   * [`mark_used`]: Self::mark_used
   */
  public override fun `unmarkUsed`(
    `keychain`: KeychainKind,
    `index`: kotlin.UInt,
  ): kotlin.Boolean
  ...
  public companion object {
    ...
    public fun `createFromTwoPathDescriptor`(
...
public sealed class AddressParseException : kotlin.Exception() {
  public class Base58() : AddressParseException() {
    override val message: String
      get() = ""
  }

  public class Bech32() : AddressParseException() {
    override val message: String
      get() = ""
  }
  ...
  public class UnknownHrp() : AddressParseException() {
    override val message: String
      get() = ""
  }

  public class LegacyAddressTooLong() : AddressParseException() {
    override val message: String
      get() = ""
  }

  public class InvalidBase58PayloadLength() : AddressParseException() {
    override val message: String
      get() = ""
  }

  public class InvalidLegacyPrefix() : AddressParseException() {
    override val message: String
      get() = ""
  }

  public class NetworkValidation() : AddressParseException() {
    override val message: String
      get() = ""
  }

  public class OtherAddressParseErr() : AddressParseException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class Bip32Exception : kotlin.Exception() {
  public class CannotDeriveFromHardenedKey() : Bip32Exception() {
    override val message: String
      get() = ""
  }
  ...
  public class InvalidChildNumberFormat() : Bip32Exception() {
    override val message: String
      get() = ""
  }

  public class InvalidDerivationPathFormat() : Bip32Exception() {
    override val message: String
      get() = ""
  }
...
public sealed class Bip39Exception : kotlin.Exception() {
  ...
  public class InvalidChecksum() : Bip39Exception() {
    override val message: String
      get() = ""
  }
...
public sealed class CbfException : kotlin.Exception() {
  public class NodeStopped() : CbfException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class CreateTxException : kotlin.Exception() {
  ...
  public class Version0() : CreateTxException() {
    override val message: String
      get() = ""
  }

  public class Version1Csv() : CreateTxException() {
    override val message: String
      get() = ""
  }
  ...
  public class NoUtxosSelected() : CreateTxException() {
    override val message: String
      get() = ""
  }
  ...
  public class ChangePolicyDescriptor() : CreateTxException() {
    override val message: String
      get() = ""
  }
  ...
  public class NoRecipients() : CreateTxException() {
    override val message: String
      get() = ""
  }
  ...
  public class PushBytesException() : CreateTxException() {
    override val message: String
      get() = ""
  }

  public class LockTimeConversionException() : CreateTxException() {
    override val message: String
      get() = ""
  }
...
public sealed class CreateWithPersistException : kotlin.Exception() {
  ...
  public class DataAlreadyExists() : CreateWithPersistException() {
    override val message: String
      get() = ""
  }
...
public sealed class DescriptorException : kotlin.Exception() {
  public class InvalidHdKeyPath() : DescriptorException() {
    override val message: String
      get() = ""
  }

  public class InvalidDescriptorChecksum() : DescriptorException() {
    override val message: String
      get() = ""
  }

  public class HardenedDerivationXpub() : DescriptorException() {
    override val message: String
      get() = ""
  }

  public class MultiPath() : DescriptorException() {
    override val message: String
      get() = ""
  }
  ...
  public class ExternalAndInternalAreTheSame() : DescriptorException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class DescriptorKeyException : kotlin.Exception() {
  ...
  public class InvalidKeyType() : DescriptorKeyException() {
    override val message: String
      get() = ""
  }
...
public sealed class ElectrumException : kotlin.Exception() {
  ...
  public class AlreadySubscribed() : ElectrumException() {
    override val message: String
      get() = ""
  }

  public class NotSubscribed() : ElectrumException() {
    override val message: String
      get() = ""
  }
  ...
  public class MissingDomain() : ElectrumException() {
    override val message: String
      get() = ""
  }

  public class AllAttemptsErrored() : ElectrumException() {
    override val message: String
      get() = ""
  }
  ...
  public class CouldntLockReader() : ElectrumException() {
    override val message: String
      get() = ""
  }

  public class Mpsc() : ElectrumException() {
    override val message: String
      get() = ""
  }
  ...
  public class RequestAlreadyConsumed() : ElectrumException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class EsploraException : kotlin.Exception() {
  ...
  public class TransactionNotFound() : EsploraException() {
    override val message: String
      get() = ""
  }
  ...
  public class HeaderHashNotFound() : EsploraException() {
    override val message: String
      get() = ""
  }
  ...
  public class RequestAlreadyConsumed() : EsploraException() {
    override val message: String
      get() = ""
  }

  public class InvalidResponse() : EsploraException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class ExtractTxException : kotlin.Exception() {
  ...
  public class MissingInputValue() : ExtractTxException() {
    override val message: String
      get() = ""
  }

  public class SendingTooMuch() : ExtractTxException() {
    override val message: String
      get() = ""
  }

  public class OtherExtractTxErr() : ExtractTxException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class FeeRateException : kotlin.Exception() {
  public class ArithmeticOverflow() : FeeRateException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class FromScriptException : kotlin.Exception() {
  public class UnrecognizedScript() : FromScriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class OtherFromScriptErr() : FromScriptException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class LoadWithPersistException : kotlin.Exception() {
  ...
  public class CouldNotLoad() : LoadWithPersistException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class MiniscriptException : kotlin.Exception() {
  public class AbsoluteLockTime() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class AtOutsideOr() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class BareDescriptorAddr() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class CouldNotSatisfy() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class ImpossibleSatisfaction() : MiniscriptException() {
    override val message: String
      get() = ""
  }

  public class InvalidOpcode() : MiniscriptException() {
    override val message: String
      get() = ""
  }

  public class InvalidPush() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class MaxRecursiveDepthExceeded() : MiniscriptException() {
    override val message: String
      get() = ""
  }

  public class MissingSig() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class MultiColon() : MiniscriptException() {
    override val message: String
      get() = ""
  }

  public class MultipathDescLenMismatch() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class NonStandardBareScript() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class ParseThreshold() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class PubKeyCtxException() : MiniscriptException() {
    override val message: String
      get() = ""
  }

  public class RelativeLockTime() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class Threshold() : MiniscriptException() {
    override val message: String
      get() = ""
  }

  public class TrNoScriptCode() : MiniscriptException() {
    override val message: String
      get() = ""
  }
  ...
  public class UnexpectedStart() : MiniscriptException() {
    override val message: String
      get() = ""
  }
...
public sealed class ParseAmountException : kotlin.Exception() {
  public class OutOfRange() : ParseAmountException() {
    override val message: String
      get() = ""
  }

  public class TooPrecise() : ParseAmountException() {
    override val message: String
      get() = ""
  }

  public class MissingDigits() : ParseAmountException() {
    override val message: String
      get() = ""
  }

  public class InputTooLarge() : ParseAmountException() {
    override val message: String
      get() = ""
  }
  ...
  public class OtherParseAmountErr() : ParseAmountException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class PsbtException : kotlin.Exception() {
  public class InvalidMagic() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class MissingUtxo() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class InvalidSeparator() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class PsbtUtxoOutOfBounds() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class InvalidProprietaryKey() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class UnsignedTxHasScriptSigs() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class UnsignedTxHasScriptWitnesses() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class MustHaveUnsignedTx() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class NoMorePairs() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class UnexpectedUnsignedTx() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class InvalidPreimageHashPair() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class NegativeFee() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class FeeOverflow() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class InvalidXOnlyPublicKey() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class InvalidControlBlock() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class InvalidLeafVersion() : PsbtException() {
    override val message: String
      get() = ""
  }

  public class Taproot() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class XPubKey() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class PartialDataConsumption() : PsbtException() {
    override val message: String
      get() = ""
  }
  ...
  public class OtherPsbtErr() : PsbtException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class RequestBuilderException : kotlin.Exception() {
  public class RequestAlreadyConsumed() : RequestBuilderException() {
    override val message: String
      get() = ""
  }
}
...
public sealed class SignerException : kotlin.Exception() {
  public class MissingKey() : SignerException() {
    override val message: String
      get() = ""
  }

  public class InvalidKey() : SignerException() {
    override val message: String
      get() = ""
  }

  public class UserCanceled() : SignerException() {
    override val message: String
      get() = ""
  }

  public class InputIndexOutOfRange() : SignerException() {
    override val message: String
      get() = ""
  }

  public class MissingNonWitnessUtxo() : SignerException() {
    override val message: String
      get() = ""
  }

  public class InvalidNonWitnessUtxo() : SignerException() {
    override val message: String
      get() = ""
  }

  public class MissingWitnessUtxo() : SignerException() {
    override val message: String
      get() = ""
  }

  public class MissingWitnessScript() : SignerException() {
    override val message: String
      get() = ""
  }

  public class MissingHdKeypath() : SignerException() {
    override val message: String
      get() = ""
  }

  public class NonStandardSighash() : SignerException() {
    override val message: String
      get() = ""
  }

  public class InvalidSighash() : SignerException() {
    override val message: String
      get() = ""
  }
...
public sealed class TransactionException : kotlin.Exception() {
  public class Io() : TransactionException() {
    override val message: String
      get() = ""
  }

  public class OversizedVectorAllocation() : TransactionException() {
    override val message: String
      get() = ""
  }
  ...
  public class NonMinimalVarInt() : TransactionException() {
    override val message: String
      get() = ""
  }

  public class ParseFailed() : TransactionException() {
    override val message: String
      get() = ""
  }
  ...
  public class OtherTransactionErr() : TransactionException() {
    override val message: String
      get() = ""
  }
}

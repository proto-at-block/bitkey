...
void * uniffi_bdk_fn_method_bumpfeetxbuilder_drain_to(void * ptr, void * script, UniffiRustCallStatus *_Nonnull out_status
);
...
int16_t uniffi_bdk_checksum_method_bumpfeetxbuilder_drain_to(void

...
@Preview
@Composable
internal fun StatementWithIconAndTitleAndBodyPreview() {
  PreviewWalletTheme {
    Statement(
...
@Preview
@Composable
internal fun StatementWithShortTitleAndLongBodyPreview() {
  PreviewWalletTheme {
    Statement(
      icon = Icon.LargeIconCheckStroked,
      title = "Statement Title",
...
@Preview
@Composable
internal fun StatementWithTitleOnlyPreview() {
  PreviewWalletTheme {
    Statement(
      icon = Icon.LargeIconCheckStroked,
      title = "Statement Title"
...
@Preview
@Composable
internal fun StatementWithLongTitleOnlyPreview() {
  PreviewWalletTheme {
    Statement(
      icon = Icon.LargeIconCheckStroked,
      title = LONG_TEXT
...
@Preview
@Composable
internal fun StatementWithBodyOnlyPreview() {
  PreviewWalletTheme {
    Statement(
      icon = Icon.LargeIconCheckStroked,
      title = null,
...
@Preview
@Composable
internal fun StatementWithLongBodyOnlyPreview() {
  PreviewWalletTheme {
    Statement(
      icon = Icon.LargeIconCheckStroked,
      title = null,
...
@Preview
@Composable
internal fun NumberedStatementWithTitleAndBodyPreview() {
  PreviewWalletTheme {
    Statement(

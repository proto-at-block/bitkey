...
private val Icon.drawableRes
  get() =
    when (this) {
      ...
      BitkeyDevice3D -> R.drawable.bitkey_device_3d
      BitkeyDeviceRaised -> R.drawable.bitkey_device_raised
      BitkeyDeviceRaisedSmall -> R.drawable.bitkey_device_raised_small
      BuyOwnBitkeyHero -> R.drawable.buy_own_bitkey_hero
      CloudBackupEmergencyAccessKit -> R.drawable.cloud_backup_emergency_access_kit
      CloudBackupMobileKey -> R.drawable.cloud_backup_mobile_key
      LargeIconAdd -> R.drawable.large_icon_add
      LargeIconCheckFilled -> R.drawable.large_icon_check_filled
      LargeIconCheckStroked -> R.drawable.large_icon_check_stroked
      LargeIconEllipsisFilled -> R.drawable.large_icon_ellipsis_filled
      LargeIconNetworkError -> R.drawable.large_icon_network_error
      LargeIconReceive -> R.drawable.large_icon_receive
      LargeIconSend -> R.drawable.large_icon_send
      LargeIconShieldPerson -> R.drawable.large_icon_shield_person
      LargeIconSpeedometer -> R.drawable.large_icon_speedometer
      LargeIconWarningFilled -> R.drawable.large_icon_warning_filled
      LargeIconWarningStroked -> R.drawable.large_icon_warning_stroked
      MediumIconQrCode -> R.drawable.medium_icon_qr_code
      MediumIconTrustedContact -> R.drawable.medium_icon_trusted_contact
      MoneyHomeHero -> R.drawable.money_home_hero
      SmallIconAccount -> R.drawable.small_icon_account
      SmallIconAnnouncement -> R.drawable.small_icon_announcement
      SmallIconArrowDown -> R.drawable.small_icon_arrow_down
      SmallIconArrowLeft -> R.drawable.small_icon_arrow_left
      SmallIconArrowRight -> R.drawable.small_icon_arrow_right
      SmallIconArrowUp -> R.drawable.small_icon_arrow_up
      SmallIconArrowUpRight -> R.drawable.small_icon_arrow_up_right
      SmallIconBitcoinStroked -> R.drawable.small_icon_bitcoin_stroked
      SmallIconBitkey -> R.drawable.small_icon_bitkey
      SmallIconBitkeyReceive -> R.drawable.small_icon_bitkey_receive
      SmallIconBitkeySend -> R.drawable.small_icon_bitkey_send
      SmallIconCaretDown -> R.drawable.small_icon_caret_down
      SmallIconCaretLeft -> R.drawable.small_icon_caret_left
      ...
      SmallIconDigitThree -> R.drawable.small_icon_digit_three
      SmallIconDigitTwo -> R.drawable.small_icon_digit_two
      ...
      SmallIconMinusStroked -> R.drawable.small_icon_minus_stroked
      SmallIconMobileKey -> R.drawable.small_icon_mobile_key
      SmallIconMobileLimit -> R.drawable.small_icon_mobile_limit
      SmallIconNotification -> R.drawable.small_icon_notification
      SmallIconPause -> R.drawable.small_icon_pause
      SmallIconPauseFilled -> R.drawable.small_icon_pause_filled
      SmallIconPauseStroked -> R.drawable.small_icon_pause_stroked
      SmallIconPhone -> R.drawable.small_icon_phone
      SmallIconPlus -> R.drawable.small_icon_plus
      SmallIconPlusFilled -> R.drawable.small_icon_plus_filled
      SmallIconPlusStroked -> R.drawable.small_icon_plus_stroked
      ...
      SmallIconShieldPerson -> R.drawable.small_icon_shield_person
      SmallIconSpeed -> R.drawable.small_icon_speed
      SmallIconSwap -> R.drawable.small_icon_swap
      SmallIconSync -> R.drawable.small_icon_sync
      SmallIconTicket -> R.drawable.small_icon_ticket
      SmallIconVideo -> R.drawable.small_icon_video
      SmallIconWallet -> R.drawable.small_icon_wallet
      SmallIconWarning -> R.drawable.small_icon_warning
      SmallIconWarningFilled -> R.drawable.small_icon_warning_filled

...
class FirmwareTelemetryEventQueueImplTests : FunSpec({
  val sqlDriver = inMemorySqlDriver()
  lateinit var queue: FirmwareTelemetryEventQueue
  val events =
  ...
  beforeTest {
    ...
    queue = FirmwareTelemetryEventQueueImpl(databaseProvider)
  }

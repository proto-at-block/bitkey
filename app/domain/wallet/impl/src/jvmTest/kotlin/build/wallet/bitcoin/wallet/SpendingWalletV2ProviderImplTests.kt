...
class SpendingWalletV2ProviderImplTests : FunSpec({
  ...
  lateinit var provider: SpendingWalletV2ProviderImpl

  beforeTest {
    accountConfigService.reset()
    provider =
      SpendingWalletV2ProviderImpl(
  ...
  test("creates SpendingWalletV2Impl when networks match") {
    ...
    (wallet is SpendingWalletV2Impl).shouldBe(true)
  }
})

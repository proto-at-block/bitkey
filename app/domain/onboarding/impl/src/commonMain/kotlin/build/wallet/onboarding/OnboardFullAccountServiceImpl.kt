...
class OnboardFullAccountServiceImpl(
    ...
    coroutineBinding {
      ...
      onboardingAppKeyKeystore
        .persistAppKeys(
          ...
          bitcoinNetworkType = appKeyBundle.networkType
        )
  ...
  private suspend fun generateAppKeys(
    ...
    coroutineBinding {
      ...
      when (appKeys) {
        null -> {
          appKeysGenerator.generateKeyBundle().bind()
        }
  ...
  override suspend fun createAccount(
    ...
    coroutineBinding {
      ...
      when (context) {
        ...
        is LiteToFullAccountUpgrade -> upgradeLiteAccountToFullService.upgradeAccount(
...
private fun Throwable.createAccountClientErrorCode(): CreateAccountClientErrorCode? {
  val f8eError = this as? FullAccountCreationError.AccountCreationF8eError

...
class OnboardSoftwareAccountServiceImpl(
  ...
  private val createSoftwareAccountService: CreateSoftwareAccountService,
  ...
  override suspend fun createAccount(): Result<SoftwareAccount, Throwable> =
    coroutineBinding {
      ...
      val newAppKeys = appKeysGenerator.generateKeyBundle().bind()

      val onboardingAccount = createSoftwareAccountService
        .createAccount(

...
final class NotificationSnapshotTests: XCTestCase {
    ...
    func test_recovery_channel_setup_all_needs_action() {
        let view = FormView(
            viewModel: RecoveryChannelsSetupFormBodyModelKt.RecoveryChannelsSetupFormBodyModel(
                pushItem: .init(state: .notcompleted, displayValue: "Recommended", uiErrorHint: .none, onClick: {}),
                smsItem: .init(state: .notcompleted, displayValue: "Recommended", uiErrorHint: .none, onClick: {}),
                emailItem: .init(state: .notcompleted, displayValue: "Required", uiErrorHint: .none, onClick: {}),
                onBack: {},
                learnOnClick: {},
                continueOnClick: {},
    ...
    func test_notification_preferences_setup_all_completed_v2() {
        let view = FormView(
            viewModel: RecoveryChannelsSetupFormBodyModelKt.RecoveryChannelsSetupFormBodyModel(
                pushItem: .init(state: .completed, displayValue: nil, uiErrorHint: .none, onClick: {}),
                smsItem: .init(state: .completed, displayValue: "555-123-4567", uiErrorHint: .none, onClick: {}),
                emailItem: .init(state: .completed, displayValue: "hello@example.com", uiErrorHint: .none,  onClick: {}),
                onBack: {},
                learnOnClick: {},
                continueOnClick: {},
                bottomSheetModel: nil,

...
class SharingManagerImpl: SharingManager {
    ...
    func shareData(data: OkioByteString, mimeType: MimeType, title: String, completion: ((KotlinBoolean) -> Void)? = nil) {
        ...
        do {
            ...
            let ac = UIActivityViewController(activityItems: [tempFileURL], applicationActivities: nil)

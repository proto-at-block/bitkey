...
open class HiddenBarNavigationController: UINavigationController, UIGestureRecognizerDelegate {
    ...
    public override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        guard topViewController != viewController else {
            // There have been issues with this, and if we don't catch it like this it will crash the app.
            // The root cause is that models are rapidly being emitted from KMP into [AppUiStateMachineManagerImpl]
            ...
            assertionFailure("Attempting to push view controller of same instance. See comments above assertion.")
    ...
    public func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        ...
        guard gestureRecognizer == interactivePopGestureRecognizer else {
            fatalError("We should only be the delegate of the interactivePopGestureRecognizer, not \(gestureRecognizer.debugDescription)")
        }

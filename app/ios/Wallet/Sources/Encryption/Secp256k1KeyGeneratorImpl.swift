...
public final class Secp256k1KeyGeneratorImpl: Secp256k1KeyGenerator {
    ...
    public func derivePublicKey(privateKey: Shared.Secp256k1PrivateKey) -> Shared.Secp256k1PublicKey {
    ...
    public func generatePrivateKey() throws -> Shared.Secp256k1PrivateKey {
        ...
        guard status == errSecSuccess else {
            throw Shared.Secp256k1KeyGeneratorError.PrivateKeyGenerationError(message: "SecRandomCopyBytes failed with status: \(status)").asError()
        }

    ...
    private func apply(
        ...
        case let viewModel as SplashLockModel:
            if let vc = rootViewController as? SwiftUIWrapperViewController<SplashLockScreenView> {
                vc.updateWrappedView(SplashLockScreenView(viewModel: viewModel), screenModel: screenModel)
                return .none
            } else {
                let vc = SwiftUIWrapperViewController(SplashLockScreenView(viewModel: viewModel), screenModel: screenModel)
